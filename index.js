document.addEventListener("DOMContentLoaded", () => {
  ...
  const radioInputContainers = document.querySelectorAll(
  ...
  form.addEventListener("submit", (e) => {
    ...
    if (!mortgageAmount || !mortgageTerm || !mortgageType || !interestRate)
      return;

    const { monthlyRepayment, totalRepaymentAmount } = calculateRepayments(
      mortgageAmount,
      mortgageTerm,
      interestRate
    );
